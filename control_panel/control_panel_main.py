...
from .components.compass import AngleCompass, resource_path
...
from .components.utils import SVGColorChanger, ColoredSVGButton
import control_panel.config as config
from control_panel.sender import sender
from .main_tab import MainTab, GridBackgroundWidget
