...
# Start Jetson Left Webhook Server
# Script khởi động server điều khiển pháo trái

echo "=========================================="
echo "Jetson Left - Hệ thống điều khiển pháo trái"
echo "=========================================="
